...
class="container" flexcontainer>
        <ul 
class="block-item" w-369>
          <li>
            <figure>
              <img
                src="//gw.alicdn.com/mt/TB1eQR.SpXXXXbcaFXXXXXXXXXX-369-369.png"
                alt=""
                width="100%"
              />
            </figure>
...
class="block-item" w-369>
          <li>
            <figure>
              <img
                src="//gw.alicdn.com/mt/TB1cuCrSpXXXXafaXXXXXXXXXXX-369-560.png"
                alt=""
                width="100%"
              />
            </figure>
    ...
    <div class="block block-5">
      <div class="container">
        <ul>
          <li flexcontainer>
            <figure 
w-324-324 aspectratio 
aspect-ratio="324/324">
              <div aspectratio-content>
                <img
                  src="//gw.alicdn.com/imgextra/i1/642910327/TB26bQ_bb_0UKFjy1XaXXbKfXXa_!!642910327-0-beehive-scenes.jpg"
                  alt=""
                  width="100%"
                  height="100%"
                />
